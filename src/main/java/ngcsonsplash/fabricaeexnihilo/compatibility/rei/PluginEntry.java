...
import ngcsonsplash.fabricaeexnihilo.compatibility.recipeviewer.SieveRecipeCombiner;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.barrel.BarrelCategory;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.barrel.BarrelDisplay;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.barrel.MilkingCategory;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.barrel.MilkingDisplay;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.crucible.CrucibleCategory;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.crucible.CrucibleDisplay;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.crucible.CrucibleHeatCategory;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.crucible.CrucibleHeatDisplay;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.sieve.SieveCategory;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.sieve.SieveDisplay;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.tools.ToolCategory;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.tools.ToolDisplay;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.witchwater.WitchWaterEntityCategory;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.witchwater.WitchWaterEntityDisplay;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.witchwater.WitchWaterWorldCategory;
import ngcsonsplash.fabricaeexnihilo.compatibility.rei.witchwater.WitchWaterWorldDisplay;
...
import ngcsonsplash.fabricaeexnihilo.util.Lazy;
